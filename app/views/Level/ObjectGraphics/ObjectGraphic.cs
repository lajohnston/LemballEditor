...
namespace LemballEditor.View.Level.ObjectGraphics
{
        ...
        public abstract class ObjectGraphic
        {
            ...
            public static Color TransparentColour
            {
                get
                {
                    return transparent;
            ...
            public virtual Bitmap Image
            {
                get
                {
                    ...
                    return ImageCache.NullObjectImage;
                }
            }
            ...
            public Point CentrePoint
            {
                get
                {
                    ...
                    return new Point(lastDrawnArea.X += DrawOffset.X, lastDrawnArea.Y += DrawOffset.Y);
                }
            }
            ...
            public static ObjectGraphic New(LevelObject levelObject, MapPanel mapPanel)
            {
                ...
                else if (levelObject is Lever)
                    return new LeverGraphic((Lever)levelObject, mapPanel);
                else if (levelObject is Lift)
                    return new LiftGraphic((Lift)levelObject, mapPanel);
                else
            ...
            public void Draw(Graphics g, TileCoordinate tile)
            {
                if (SnapsToTile())
                {
                    ...
                    int elevation = mapPanel.GetTileDrawElevation(tile, true);
                    Draw(g, position, 0);
                }
                else
                {
            ...
            public virtual void DrawAtCursor(Graphics g)
            {
                ...
                {
                    mapPanel.GetTileDrawElevation(mouseOverTile, true);
                }
                ...
                this.Draw(g, position, elevation);
            }
