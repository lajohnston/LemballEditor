...
{
    [TestClass]
    public sealed class UnknownASerializerTests
    {
        [TestMethod]
        public void Deserialize_ShouldThrowAnExceptionIfTheValueIsAboveTheByteMaxSize()
        {
            ...
            var act = () => new UnknownASerializer().Deserialize(reader, level);
        ...
        public void Deserialize_ShouldThrowAnExceptionIfTheUnknownAValueIsInvalid()
        {
            ...
            var act = () => new UnknownASerializer().Deserialize(reader, mockLevel.Object);
        ...
        public void Serialize_ShouldWriteTheUShortToTheStream()
        {
            ...
            var serializer = new UnknownASerializer();
