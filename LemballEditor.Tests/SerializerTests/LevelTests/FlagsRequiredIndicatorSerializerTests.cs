...
{
    [TestClass]
    public sealed class FlagsRequiredIndicatorSerializerTests
    {
        [TestMethod]
        public void Deserialize_ShouldThrowAnExceptionIfTheValueIsAboveTheByteMaxSize()
        {
            ...
            var act = () => new FlagsRequiredIndicatorSerializer().Deserialize(reader, level);
        ...
        public void Deserialize_ShouldThrowAnExceptionIfTheValueIsInvalid()
        {
            ...
            var act = () => new FlagsRequiredIndicatorSerializer().Deserialize(reader, mockLevel.Object);
        ...
        public void Deserialize_ShouldSetTheFlagsRequiredToZero_WhenTheValueIsSeven()
        {
            ...
            _ = new FlagsRequiredIndicatorSerializer().Deserialize(reader, level);
        ...
        public void Serialize_ShouldWriteTheUShortToTheStream()
        {
            ...
            var serializer = new FlagsRequiredIndicatorSerializer();
