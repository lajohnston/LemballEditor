...
{
    [TestClass]
    public class DataBlockSerializerTests
    {
        public (DataBlockSerializer<int>, Mock<ISerializer<int>>) CreateSerializer(string header = "TEST")
        {
            var bodySerializer = new Mock<ISerializer<int>>();
            var serializer = new DataBlockSerializer<int>(header, bodySerializer.Object);
