...
{
    [TestClass]
    public sealed class ConstantSerializerTests
    {
        [TestMethod]
        ...
        )
        {
            ...
            var act = () => new ConstantSerializer<string>(validData, dataDescripion).Deserialize(reader, fakeModel);
        ...
        public void Serialize_ShouldWriteTheConstantDataBytesToTheStream()
        {
            ...
            new ConstantSerializer<bool>(validHeader, "data").Serialize(true, writer);
